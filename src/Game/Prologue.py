...
def initial_prologue(hero_name):
    clear()
    print_with_delay(r"""
  ____   _   _  _   _   ____  _____   ___   _   _   _____ _   _ ____   _   _ 
 |  _ \ | | | || \ | | / ___ | ____| / _ \ | \ | | |_   _| | | |  _  \| \ | | 
 | | | || | | ||  \| || | __ |  _|  | | | ||  \| |   | | | | | | |_) ||  \| |
 | |_| || |_| || |\  || |_| || |___ | |_| || |\  |   | | | |_| |  _  /| |\  | 
 |____/  \___/ |_| \_| \___/ |_____| \___/ |_| \_|   |_|  \___/|_| \_\|_| \_|
    ...
    print_with_delay("A princesa Neméia foi sequestrada por um dragão alado.")
    ...
    print_with_delay("\nO dragão aguarda em sua masmorra, entre as cinzas de batalhas passadas...")
